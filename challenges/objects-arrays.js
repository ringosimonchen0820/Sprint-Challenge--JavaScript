...
const lowCaseAnimalNames = zooAnimals.map((animalLower) => {
  return `${animalLower.animal_name.toLocaleLowerCase()}`;
});
...
*/
const populationTotal = zooAnimals.reduce((total, speciesPopulation) => {
  return total + speciesPopulation.population
}, 0);
